...
def main():
    ...
    beta_range = np.arange(args.beta_start, args.beta_end + args.beta_step, args.beta_step)
    prev_beta_outfolder = None
    for i, beta_currrent in enumerate(beta_range):
        print("i: ", i)
        args.beta = beta_currrent
        init_out_dir()
        ...
        for step in range(1, args.max_step + 1):
            ...
            if i == 0:
                ...
                beta = args.beta - args.beta_step + args.beta_step * 1 / (1 + np.exp(-10* (2 * step / args.max_step - 1)))
